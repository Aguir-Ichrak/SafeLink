          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('users') && 'bg-slate-900'}`}>
                ...
                >
                  <div className="flex items-center">
                    <img className="shrink-0 h-6 w-6" viewBox="0 0 24 24" src='src/images/users.png'/>
              ...
              {/* buildings */}
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('buildings') && 'bg-slate-900'}`}>
                <NavLink
                  end
                  to="/buildings"
                  className={`block text-slate-200 truncate transition duration-150 ${
                ...
                >
                  <div className="flex items-center">
                  <img className="shrink-0 h-6 w-6" viewBox="0 0 24 24" src='src/images/buildings.png'/>
                    <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                    Buildings
                    </span>
                  </div>
                    ...
                    <React.Fragment>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/sign-up" className="block text-slate-400 hover:text-slate-200 transition duration-150 truncate">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Sign up
                              </span>
                            </NavLink>
